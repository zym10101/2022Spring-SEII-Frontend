      ...
      <div style="width: 90%; margin: 0 auto">
        <el-form :model="purchaseForm" label-width="80px" ref="purchaseForm" :rules="rules">
          ...
          <el-form-item
            ...
            :label="'商品' + index">
            <div>
              <el-select v-model="item.pid" placeholder="请选择商品id" style="width: 31%; margin-right: 3%">
                <el-option
              ...
              <el-input v-model="item.quantity" style="width: 31%; margin-right: 3%" placeholder="请输入商品数量"></el-input>
              <el-input v-model="item.unitPrice" style="width: 31%;" placeholder="请输入商品单价"></el-input>
            </div>
            <div style="margin-top: 10px">
              <el-input v-model="item.remark" style="width: 60%; margin-right: 3%" placeholder="请填写备注"></el-input>
              <el-button type="primary" size="small" @click="addProduct"
                         v-if="index === purchaseForm.purchaseSheetContent.length - 1">继续添加
              </el-button>
              <el-button type="danger" size="small" @click.prevent="removeProduct(item)" v-if="index !== 0">删除</el-button>
            </div>
          </el-form-item>
