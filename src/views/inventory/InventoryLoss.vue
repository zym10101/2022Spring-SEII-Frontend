<template>
  <Layout>
    ...
    （当实际库房中的商品数量比系统中的少时要进行库存报损，向系统库存中减少商品使一致。）
    <div class="table-body">
      ...
      >
        ...
        <el-table-column prop="bsQuantity" label="报损数量" min-width="12%">
        </el-table-column>
      </el-table>
    </div>
  </Layout>
...
import { getWarehouseLOSS } from "@/network/warehouse";
